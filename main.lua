...
function love.load()
	...
	button = Watch.new({"up", "down", "left", "right", "a", "b", "start", "quit"}, function(key) return love.keyboard.isDown(button.map[key]) end)
